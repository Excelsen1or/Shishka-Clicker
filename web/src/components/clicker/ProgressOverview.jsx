    ...
    <div className="progress-overview">
      <div className="progress-loop">
        ...
        <div className="progress-loop__steps">
          ...
          <div className="loop-step"><b>2.</b> Вкладываешь их в ветки за <b>💵 деньги</b>, <b>📚 знания</b> и теперь ещё в отдельные <b>🌰 шишечные апгрейды</b></div>
          <div className="loop-step"><b>3.</b> Открываешь престиж → закрываешь квоту цикла → получаешь редкие осколки</div>
        </div>
      </div>
