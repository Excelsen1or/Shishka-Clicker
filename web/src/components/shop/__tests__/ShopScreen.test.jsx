...
describe('ShopScreen', () => {
  it('renders purchases tabs and building perk text', () => {
                ...
                upgrades: [
                  {
                    ...
                    canBuy: false,
                    unlocked: false,
                    unlockText: 'Откроется после первых 80 шишек за все жизни.',
    ...
    expect(html).toContain('стартовый темп')
                ...
                subscriptions: [
                  {
                    ...
                    unlocked: false,
                    unlockText:
                      'Откроется после 90 шишек за все жизни или первой покупки "Сборщик шишек у гаражей".',
